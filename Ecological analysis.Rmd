...
```{r glm.estuaries}
speciesRC.red1 <- speciesRC.red
speciesRN.red1 <- speciesRN.red
speciesCH.red1 <- speciesCH.red

colnames(speciesRC.red1) <- names[[1]][, 2]
colnames(speciesRN.red1) <- names[[2]][, 2]
colnames(speciesCH.red1) <- names[[3]][, 2]

species.rivers <- Merge(
  speciesRC.red1,
  speciesRN.red1,
  speciesCH.red1
)
...
```{r plots.glm.inland, fig.width=12, fig.height=10}
